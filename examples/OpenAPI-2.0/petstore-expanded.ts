 ...
 */
export function findPets(query: findPets_parameter_query): Promise<_Response<200, ({
            "name": string;
            "tag"?: string;
        } & {
            "id": number;
...
export function addPet(body: addPet_parameter_body): Promise<_Response<200, {
            "name": string;
            "tag"?: string;
        } & {
            "id": number;
...
export type find_pet_by_id_parameter_path = {
    "id": number;
};
export type find_pet_by_id_result_200 = {
    "name": string;
    "tag"?: string;
} & {
    "id": number;
};
export type find_pet_by_id_result_default = {
    "code": number;
    "message": string;
};
/** Returns a user based on a single ID, if the user does not have access to the pet */
export function find_pet_by_id(path: find_pet_by_id_parameter_path): Promise<_Response<200, {
            "name": string;
            "tag"?: string;
        } & {
            "id": number;
...
export function deletePet(path: deletePet_parameter_path): Promise<_Response<"default", {
            "code": number;
            "message": string;
        }>> {
