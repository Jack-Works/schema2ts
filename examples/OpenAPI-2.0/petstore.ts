...
export type listPets_result_200 = null[];
/** List all pets */
export function listPets_invoke(query: listPets_parameter_query): Promise<_Response<200, null[]>> {
...
export type showPetById_result_200 = null[];
/** Info for a specific pet */
export function showPetById_invoke(path: showPetById_parameter_path): Promise<_Response<200, null[]>> {
