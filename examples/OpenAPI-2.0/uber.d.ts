...
export declare type products_get_result_200 = {
    "product_id"?: string;
    "description"?: string;
    "display_name"?: string;
    "capacity"?: number;
...
export declare type products_get_result_default = {
    "code"?: number;
    "message"?: string;
    "fields"?: string;
};
/** The Products endpoint returns information about the Uber products offered at a given location. The response includes the display name and other details about each product, and lists the products in the proper display order. */
export declare function products_get(query: products_get_parameter_query): Promise<_Response<200, {
    "product_id"?: string;
    "description"?: string;
    "display_name"?: string;
    "capacity"?: number;
...
export declare type estimates_price_get_result_200 = {
    "product_id"?: string;
...
export declare type estimates_price_get_result_default = {
    "code"?: number;
    "message"?: string;
    "fields"?: string;
};
/** The Price Estimates endpoint returns an estimated price range for each product offered at a given location. The price estimate is provided as a formatted string with the full price range and the localized currency symbol.<br><br>The response also includes low and high estimates, and the [ISO 4217](http://en.wikipedia.org/wiki/ISO_4217) currency code for situations requiring currency conversion. When surge is active for a particular product, its surge_multiplier will be greater than 1, but the price estimate already factors in this multiplier. */
export declare function estimates_price_get(query: estimates_price_get_parameter_query): Promise<_Response<200, {
    "product_id"?: string;
    "currency_code"?: string;
    "display_name"?: string;
    "estimate"?: string;
...
export declare type estimates_time_get_result_200 = {
    "product_id"?: string;
    "description"?: string;
    "display_name"?: string;
    "capacity"?: number;
...
export declare type estimates_time_get_result_default = {
    "code"?: number;
    "message"?: string;
    "fields"?: string;
};
/** The Time Estimates endpoint returns ETAs for all products offered at a given location, with the responses expressed as integers in seconds. We recommend that this endpoint be called every minute to provide the most accurate, up-to-date ETAs. */
export declare function estimates_time_get(query: estimates_time_get_parameter_query): Promise<_Response<200, {
    "product_id"?: string;
    "description"?: string;
    "display_name"?: string;
    "capacity"?: number;
...
export declare type me_get_result_200 = {
    "first_name"?: string;
    "last_name"?: string;
    "email"?: string;
    "picture"?: string;
...
export declare type me_get_result_default = {
    "code"?: number;
    "message"?: string;
    "fields"?: string;
};
/** The User Profile endpoint returns information about the Uber user that has authorized with the application. */
export declare function me_get(): Promise<_Response<200, {
    "first_name"?: string;
    "last_name"?: string;
    "email"?: string;
    "picture"?: string;
...
export declare type history_get_result_200 = {
    "offset"?: number;
    "limit"?: number;
    "count"?: number;
    "history"?: {
...
export declare type history_get_result_default = {
    "code"?: number;
    "message"?: string;
    "fields"?: string;
};
/** The User Activity endpoint returns data about a user's lifetime activity with Uber. The response will include pickup locations and times, dropoff locations and times, the distance of past requests, and information about which products were requested.<br><br>The history array in the response will have a maximum length based on the limit parameter. The response value count may exceed limit, therefore subsequent API requests may be necessary. */
export declare function history_get(query: history_get_parameter_query): Promise<_Response<200, {
    "offset"?: number;
    "limit"?: number;
    "count"?: number;
    "history"?: {
